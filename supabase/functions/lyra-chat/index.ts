...
const openAIApiKey = Deno.env.get('lyra-file-recovery-open-ai-api-key');
...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are Lyra, an AI assistant specialized in file recovery. You are part of the Neuronix Recovery AI system. 
...
Always be encouraging about recovery prospects and provide actionable advice.`;
